...
var QuestionAnswer = require('../model/QuestionAnswer');
...
describe('QuestionAnswer', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("QuestionAnswer").delete();
        })();
        done();
    });
    describe('Test questionanswer', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("add questionanswer 1");

                var res = yield chai.request(server)
                    .post('/questionanswer/add')
                    .send({
                        "id":id
                    });
                logRes(res);
                ...
                console.log("get questionanswer");
                ...
                console.log("delete questionanswer 1");
                res = yield chai.request(server)
                ...
                console.log("get questionanswer again");
                res = yield chai.request(server)
