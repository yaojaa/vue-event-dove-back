...
describe('ContactUs', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("ContactUs").delete();
        })();
        done();
    });
    describe('Test contactus', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete contactus 1");
                res = yield chai.request(server)
                    .post('/contactus/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get contactus again");
                res = yield chai.request(server)
                    .get('/contactuss/'+id);
                logRes(res);
                res.should.have.status(200);
