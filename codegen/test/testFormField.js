...
var FormField = require('../model/FormField');
...
describe('FormField', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("FormField").delete();
        })();
        done();
    });
    describe('Test formfield', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete formfield 1");
                res = yield chai.request(server)
                    .post('/formfield/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get formfield again");
                res = yield chai.request(server)
                    .get('/formfields/'+id);
                logRes(res);
                res.should.have.status(200);
