...
var EventGroup = require('../model/EventGroup');
...
describe('EventGroup', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("EventGroup").delete();
        })();
        done();
    });
    describe('Test eventgroup', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete eventgroup 1");
                res = yield chai.request(server)
                    .post('/eventgroup/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get eventgroup again");
                res = yield chai.request(server)
                    .get('/eventgroups/'+id);
                logRes(res);
                res.should.have.status(200);
