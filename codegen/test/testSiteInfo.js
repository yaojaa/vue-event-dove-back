...
describe('SiteInfo', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("SiteInfo").delete();
        })();
        done();
    });
    describe('Test siteinfo', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete siteinfo 1");
                res = yield chai.request(server)
                    .post('/siteinfo/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get siteinfo again");
                res = yield chai.request(server)
                    .get('/siteinfos/'+id);
                logRes(res);
                res.should.have.status(200);
