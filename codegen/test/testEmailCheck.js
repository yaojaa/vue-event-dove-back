...
var EmailCheck = require('../model/EmailCheck');
...
describe('EmailCheck', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("EmailCheck").delete();
        })();
        done();
    });
    describe('Test emailcheck', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete emailcheck 1");
                res = yield chai.request(server)
                    .post('/emailcheck/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get emailcheck again");
                res = yield chai.request(server)
                    .get('/emailchecks/'+id);
                logRes(res);
                res.should.have.status(200);
