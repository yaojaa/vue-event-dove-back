...
var DeviceAuth = require('../model/DeviceAuth');
...
describe('DeviceAuth', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("DeviceAuth").delete();
        })();
        done();
    });
    describe('Test deviceauth', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete deviceauth 1");
                res = yield chai.request(server)
                    .post('/deviceauth/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get deviceauth again");
                res = yield chai.request(server)
                    .get('/deviceauths/'+id);
                logRes(res);
                res.should.have.status(200);
