...
var EventRole = require('../model/EventRole');
...
describe('EventRole', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("EventRole").delete();
        })();
        done();
    });
    describe('Test eventrole', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete eventrole 1");
                res = yield chai.request(server)
                    .post('/eventrole/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get eventrole again");
                res = yield chai.request(server)
                    .get('/eventroles/'+id);
                logRes(res);
                res.should.have.status(200);
