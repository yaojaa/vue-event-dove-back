...
var PayOrder = require('../model/PayOrder');
...
describe('PayOrder', function() {
    ...
    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            ...
            yield r.table("PayOrder").delete();
        })();
        done();
    });
    describe('Test payorder', function() {
        it('it should pass', function(done) {
            const tests = Promise.coroutine(function*() {
                ...
                console.log("delete payorder 1");
                res = yield chai.request(server)
                    .post('/payorder/delete')
                    .send({"id":aid1});
                logRes(res);
                res.should.have.status(200);
                res.body.should.be.a('object');
                ...
                console.log("get payorder again");
                res = yield chai.request(server)
                    .get('/payorders/'+id);
                logRes(res);
                res.should.have.status(200);
