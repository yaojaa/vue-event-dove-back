...
var EdRole = require('../model/EdRole');
...
describe('EdRole', function() {

    before(function(done) {
        const deletetables = Promise.coroutine(function*() {
            // runs before all tests in this block
            yield r.table("EdRole").delete();
        })();
        done();
    });
    describe('Test edrole', function() {
